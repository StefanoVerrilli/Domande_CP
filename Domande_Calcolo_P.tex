...
\color{black} \item Spiega le caratteristiche della clausola \emph{shared} del costrutto \emph{parallel} della libreria OpenMp?
...
\color{black} \item Sapresti spiegare il perchè nel calcolo della complessità di tempo del nucleo computazionale del prodotto matrice-vettore con seconda e terza strategia di suddivisione dei dati non compare, nel calcolo della collezione dei risultati, il termine relativo al numero di righe \emph{M} ne tanto meno il numero di processori colonna \emph{p}?
